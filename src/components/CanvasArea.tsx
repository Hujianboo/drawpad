    ...
    <div className="flex-1 flex flex-col bg-white ">
      ...
      <div className="p-2 flex items-center justify-between border-t border-gray-200 ">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="w-8 h-8 flex items-center justify-center bg-gray-100 0 hover:bg-gray-200 0 rounded transition-colors"
            >
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs text-gray-500  uppercase font-medium">Toy Mode</span>
          ...
          {/* 颜色指示器 */}
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded border-2 border-gray-300 " style={{ backgroundColor: '#000000' }}></div>
            <div className="w-8 h-8 rounded border-2 border-gray-300 " style={{ backgroundColor: currentColor }}></div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={onSave}
              className="px-8 py-2 bg-black  text-white  rounded-lg hover:bg-gray-800  transition-colors font-medium"
          >
            Save
          </button>
        </div>
